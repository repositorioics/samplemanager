            ...
            var table1 =  $('#lista_entidades').DataTable({
                ...
                ajax:{
                    ...
                    data: function (d) {
                        ...
                        var filtros = {};
                        filtros['primers_id'] = $('#primers_id').val();
                        filtros['primer_number'] =  $('#primer_number').val();
                        filtros['primer_name'] =  $('#primer_nmae').val();
                        filtros['primer_sequence'] =  $('#primer_sequence').val();
                ...
                columns: [
                    {data: 'primers_id'},
                    { data: 'primer_number' },
                    { data: 'position_in_sequence'},
                    { data: 'date_received'},
                    { data: 'primer_name'},
                    { data: 'primer_description' },
                    { data: 'primer_sequence' },
                    { data: 'primer_lenght' },
                    { data: 'primer_designer'},
                    { data: 'comments'},
                    { data: 'loc_freezer' },
                    { data: 'loc_rack' },
                    { data: 'loc_box' },
