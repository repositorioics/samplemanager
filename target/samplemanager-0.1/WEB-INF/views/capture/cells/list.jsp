        ...
        <div class="layout-container">
            ...
            <div class="layout-content">
                ...
                <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <spring:url value="/capture/cells/newEntity/" var="newEntity"/>
                    <spring:url value="/capture/cells/uploadEntity/" var="uploadEntity"/>
                                    ...
                                    <form action="#" autocomplete="off" id="search-form">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="cell_id" name="cell_id"
                                                               ...
                                                               title="<spring:message code="cell_id" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="cell_id" />">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" align="right">
                                            ...
                                            <button type="submit" class="btn rounded-pill btn-outline-primary"
                                                    ...
                                                    title="<spring:message code="findcells" />"
                                                    id="search"><i class="ion ion-md-search"></i> <spring:message
                                                    code="findcells"/></button>
                                        </div>
                        ...
                        <div class="row no-gutters row-bordered">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <table id="lista_antibodies" class="table table-striped table-bordered datatable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th><spring:message code="cell_id"/></th>
                                            <th><spring:message code="cell_line_name"/></th>
                                            <th><spring:message code="passage_number"/></th>
                                            <th><spring:message code="date_frozen"/></th>
                                            <th><spring:message code="operator_name"/></th>
                                            <th><spring:message code="company_name"/></th>
                                            <th><spring:message code="catalog_code"/></th>
                                            <th><spring:message code="type_of_culture"/></th>
                                            <th><spring:message code="original_cell_type"/></th>
                                            <th><spring:message code="original_organ"/></th>
                                            <th><spring:message code="organism_name"/></th>
                                            <th><spring:message code="cell_density"/></th>
                                            <th><spring:message code="volume_mL"/></th>
                                            <th><spring:message code="freezing_medium"/></th>
                                            <th><spring:message code="culture_media"/></th>
                                            <th><spring:message code="QC_status"/></th>
                                            <th><spring:message code="QC_test_name"/></th>
