...
<!-- urls -->
<spring:url value="/capture/primers/saveEntity/" var="saveUrl"></spring:url>
<spring:url value="/capture/primers/newEntity" var="newUrl"></spring:url>
<spring:url value="/capture/primers/" var="listUrl"></spring:url>
<!-- Layout wrapper -->
    ...
    <div class="text-muted text-tiny mt-1"><small class="font-weight-normal"><fmt:formatDate value="${now}" dateStyle="long"/></small></div>
			            ...
			            <div class="card mb-4" id="edit-element">
			              <h6 class="card-header with-elements">
			                ...
			                <div class="card-header-title"><spring:message code="Primers" /></div>
			              </h6>
			              <div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="primers_id" name="primers_id"
                                                           ...
                                                           title="<spring:message code="primers_id_tool_tip" />"
                                                           class="form-control"
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="position_in_sequence"
                                                               name="position_in_sequence" data-toggle="tooltip"
                                                               data-state="primary" data-placement="right"
                                                               title="<spring:message code="position_in_sequence_tool_tip" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="position_in_sequence" />">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="date_received" name="date_received" value="${fecEnr}"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="primer_name1" name="primer_name1"
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="primer_description" name="primer_description"
                                                               data-toggle="tooltip" data-state="primary"
                                                               data-placement="right"
                                                               title="<spring:message code="primer_description_tool_tip" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="primer_description" />">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="primer_lenght" name="primer_lenght"
                                                               data-toggle="tooltip" data-state="primary"
                                                               data-placement="right"
                                                               title="<spring:message code="primer_lenght_tool_tip" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="primer_lenght" />">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="primer_designer" name="primer_designer"
                                                                   data-toggle="tooltip" data-state="primary"
                                                                   data-placement="right"
                                                                   title="<spring:message code="primer_designer_tool_tip" />"
                                                                   class="form-control"
                                                                   placeholder="<spring:message code="primer_designer" />">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
