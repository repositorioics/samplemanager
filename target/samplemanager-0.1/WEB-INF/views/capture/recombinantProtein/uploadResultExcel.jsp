			                ...
			                <div class="import-results col-md-12 col-lg-12 col-xl-12">
				                ...
				                <tbody>
				                	<c:forEach items="${entidadesErr}" var="entidad">
				                		<tr>
				                            <td><c:out value="${entidad.protrecombinante_id }" /></td>
			                  	...
			                  	<div class="row justify-content-end">
			                  		<spring:url value="/capture/plasmids/" var="listUrl"/>
	...
	jQuery(document).ready(function() {
	    ...
	    if ("${importError}"){
		  $('.import-error').show();
            ...
            swal("Total Registros:${numFilas}" + ", ${nuevos} Records inserted Successfully " +  ", ${viejos} Records updated Successfully " );
        }
