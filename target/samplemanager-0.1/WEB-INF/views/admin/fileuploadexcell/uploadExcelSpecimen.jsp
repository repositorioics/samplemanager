...
<body>
         			...
         			<div class="container-fluid flex-grow-1 container-p-y">
			            ...
			            <div class="card mb-4">
			              <h6 class="card-header">
			                <i class="fa fa-file-upload"></i>&nbsp;<strong><spring:message code="uploadEntityToolTipSpecimen" /></strong>
			              </h6>
			              <div class="card-body">
                                ...
                                <form method="POST" action="${fn:escapeXml(uploadUrl)}" enctype="multipart/form-data">
                                    <div class="d-flex align-items-start">
                                        <label class="btn rounded-pill btn-outline-primary">
                                            <i class="fa fa-hand-point-up"></i> <spring:message code="selectfileuploadSpecimen" /><input id="fileinput" name="file" type="file" accept=".xlsx,.xls" style="display: none;">
                                        </label>
                                        <span id="selected_filename"><spring:message code="noFileSelected" /></span>
                                        <div class="d-flex justify-content-around">
                                            <button type="submit" data-toggle="tooltip" data-placement="bottom" title="<spring:message code="uploadUpdateToolTip" />" class="btn rounded-pill btn-outline-primary"><i class="fa fa-check"></i> <spring:message code="Add sample records to SMS database" /></button>
                                        </div>
                                    </div>
			                </form>
                        ...
                        <table id="table1" class="table table-striped table-bordered datatable"
                            ...
                            <tr>
                                ...
                                <th><spring:message code="Volume_Units"/></th>
                                <th><spring:message code="StudyId"/></th>
                                <th><spring:message code="substudy"/></th>
                                <th><spring:message code="Orthcode"/></th>
	...
	<script>
        ...
        jQuery(document).ready(function() {
            ...
            $("li.fileupdatespecimen").addClass("active");
            $('#table').DataTable({
                dom: 'lBfrtip',
                "oLanguage": {
                    "sUrl": "${dataTablesLang}"
                ...
                "buttons": [
                    {
                        extend: 'excel',
                        text: "Download excel template for receiving boxes in SMS",
