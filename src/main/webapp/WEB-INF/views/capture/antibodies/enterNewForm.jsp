                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="select2-primary">
                                                    ...
                                                    <select class="form-control" id="freezer_name" name="freezer_name" onmousedown="if(this.options.length>5){this.size=5;}"  onchange='this.size=0;' onblur="this.size=0;"  style="width: 100%" data-allow-clear="false" data-toggle="tooltip" data-state="primary" data-placement="right" title="<spring:message code="freezer_name_tool_tip" />"
                                                            placeholder="<spring:message code="freezer_name" />" >
                                                        <option value=""></option>
                                                        <c:forEach items="${equips}" var="equip">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <option value="${equip.id}"><spring:message code="${equip.name}" /></option>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:forEach>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="shelf_name" name="shelf_name"
                                                               data-toggle="tooltip" data-state="primary"
                                                               data-placement="right"
                                                               title="<spring:message code="shelf_name_tool_tip" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="shelf_name" />">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                        ...
                                                        <div class="select2-primary">
                                                            ...
                                                            <select class="form-control" id="rack_name" name="rack_name" onmousedown="if(this.options.length>5){this.size=5;}"  onchange='this.size=0;' onblur="this.size=0;"  style="width: 100%" data-allow-clear="false" data-toggle="tooltip" data-state="primary" data-placement="right" title="<spring:message code="rack_name_tool_tip" />"
                                                                    placeholder="<spring:message code="rack_name" />" >
                                                                <option value=""></option>
                                                                <c:forEach items="${racks}" var="rack">
                                                                    <c:choose>
                                                                        <c:when test="${rack.systemId eq entidad.rack.systemId}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="select2-primary">
                                                    ...
                                                    <select class="form-control" id="box_name" name="box_name" onmousedown="if(this.options.length>5){this.size=5;}"  onchange='this.size=0;' onblur="this.size=0;"  style="width: 100%" data-allow-clear="false" data-toggle="tooltip" data-state="primary" data-placement="right" title="<spring:message code="box_name_tool_tip" />"
                                                            placeholder="<spring:message code="box_name" />" >
                                                        <option value=""></option>
                                                        <c:forEach items="${boxes}" var="box">
                                                            <c:choose>
                                                                <c:when test="${box.systemId eq entidad.box.systemId}">
                                                                    <option selected value="${box.systemId}"><spring:message code="${box.name}" /></option>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <option value="${box.id}"><spring:message code="${box.name}" /></option>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:forEach>
                                                    </select>
