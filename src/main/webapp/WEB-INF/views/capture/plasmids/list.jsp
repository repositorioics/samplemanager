        ...
        <div class="layout-container">
            ...
            <div class="layout-content">
                ...
                <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <spring:url value="/capture/plasmids/newEntity/" var="newEntity"/>
                    <spring:url value="/capture/plasmids/uploadEntity/" var="uploadEntity"/>
                    ...
                    <div class="card mb-4" id="entity-element">
                        <h6 class="card-header with-elements">
                            ...
                            <div class="card-header-title"><spring:message code="findplasmids"/></div>
                        </h6>
                                    ...
                                    <form action="#" autocomplete="off" id="search-form">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="plasmids_id" name="plasmids_id"
                                                               ...
                                                               title="<spring:message code="plasmids_id" />"
                                                               class="form-control"
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="plasmid_name"
                                                               ...
                                                               title="<spring:message code="plasmid_name_tool_tip" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="plasmid_name" />">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group" align="right">
                                            <button type="submit" class="btn rounded-pill btn-outline-primary"
                                                    ...
                                                    title="<spring:message code="findplasmids" />"
                                                    id="search"><i class="ion ion-md-search"></i> <spring:message
                                                    code="findplasmids"/></button>
                                        </div>
                                        <div>
                        ...
                        <div id="wrap" >
                            <div id="div2" >
                              <table id="lista_entidades"  class="table table-striped table-bordered datatable"   >
                                <thead>
                                <tr>
                                    <th><spring:message code="plasmids_id"/></th>
                                    <th><spring:message code="plasmid_name"/></th>
                                    <th><spring:message code="sequencing_confirmed"/></th>
                                    <th><spring:message code="sequencing_primers"/></th>
                                    <th><spring:message code="backbone_vector"/></th>
                                    <th><spring:message code="antibiotic_resistant"/></th>
                                    <th><spring:message code="growth_conditions"/></th>
                                    <th><spring:message code="midiprep_purified"/></th>
                                    <th><spring:message code="concentration"/></th>
                                    <th><spring:message code="comments"/></th>
                                    <th><spring:message code="glycerol_stock"/></th>
...
<spring:url value="/capture/plasmids/search/"
            var="searchUrl"/>

<spring:url value="/capture/plasmids/editEntity/"
            var="editUrl"/>
<spring:url value="/capture/plasmids/"
            var="viewUrl"/>
...
<!-- Custom scripts required by this view -->
    <spring:url value="/resources/js/views/PlasmidsFilter.js" var="searchProcess"/>
