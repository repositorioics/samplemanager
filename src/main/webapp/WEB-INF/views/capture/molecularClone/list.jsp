        ...
        <div class="layout-container">
            ...
            <div class="layout-content">
                ...
                <div class="container-fluid flex-grow-1 container-p-y">
                    ...
                    <spring:url value="/capture/molecularClone/newEntity/" var="newEntity"/>
                    <spring:url value="/capture/molecularClone/uploadEntity/" var="uploadEntity"/>
                                    ...
                                    <form action="#" autocomplete="off" id="search-form">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="molecularClone_id" name="molecularClone_id"
                                                               data-toggle="tooltip" data-state="danger"
                                                               data-placement="right"
                                                               title="<spring:message code="molecularClone_id" />"
                                                               class="form-control"
                                                               placeholder="<spring:message code="molecularClone_id" />">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="Specimen_id"
                                                               name="Specimen_id" data-toggle="tooltip"
                                                               data-state="primary" data-placement="right"
                                                               title="<spring:message code="Specimen_id_name_tool_tip" />"
                                                               class="form-control"
                                        ...
                                        <div class="form-group" align="right">
                                            ...
                                            <button type="submit" class="btn rounded-pill btn-outline-primary"
                                                    ...
                                                    title="<spring:message code="findmolecularClone" />"
                                                    id="search"><i class="ion ion-md-search"></i> <spring:message
                                                    code="findmolecularClone"/></button>
                                        </div>
                        ...
                        <div class="row no-gutters row-bordered">
                            <div class="col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <table id="lista_antibodies" class="table table-striped table-bordered datatable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th><spring:message code="molecularClone_id"/></th>
                                            <th><spring:message code="specimen_id"/></th>
                                            <th><spring:message code="passage_number"/></th>
                                            <th><spring:message code="date"/></th>
                                            <th><spring:message code="specimen_condition"/></th>
                                            <th><spring:message code="specimen_type"/></th>
                                            <th><spring:message code="cell_line"/></th>
                                            <th><spring:message code="experimentId"/></th>
                                            <th><spring:message code="research_name"/></th>
                                            <th><spring:message code="genus"/></th>
                                            <th><spring:message code="organism"/></th>
                                            <th><spring:message code="strain_name"/></th>
                                            <th><spring:message code="isolation_country"/></th>
                                            <th><spring:message code="collection_date"/></th>
                                            <th><spring:message code="mutation_type"/></th>
                                            <th><spring:message code="region"/></th>
                                            <th><spring:message code="note"/></th>
                                            <th><spring:message code="genetic_modification"/></th>
                                            <th><spring:message code="selection_reagent"/></th>
                                            <th><spring:message code="selection_concentration"/></th>
...
<spring:url value="/capture/cells/ClassExcForm1/"
            var="ClassExcForm1"/>

<spring:url value="/capture/cells/search/"
            var="searchUrl"/>

<spring:url value="/capture/cells/editEntity/"
            var="editUrl"/>
<spring:url value="/capture/cells/"
            var="viewUrl"/>

<spring:url value="/capture/subjects/"
            var="viewSubjectUrl"/>

<spring:url value="/capture/cells/getBoxes"
            var="boxNameUrl"/>

<!-- Custom scripts required by this view -->
<spring:url value="/resources/js/views/CellsFilter.js" var="searchProcess"/>
