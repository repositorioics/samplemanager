...
@Controller
@RequestMapping("/capture/cells/*")
public class CaptureCellsController {
    private static final Logger logger = LoggerFactory.getLogger(CaptureCellsController.class);
    ...
    public String initAddEntityForm(Model model) {
        ...
        this.visitsService.saveUserPages(this.usuarioService.getUser(SecurityContextHolder.getContext().getAuthentication().getName()),new Date(),"captureplasmidspage");
        return "capture/cells/enterNewForm";
    }
