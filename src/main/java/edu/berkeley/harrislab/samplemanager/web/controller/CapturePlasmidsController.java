...
@Controller
@RequestMapping("/capture/plasmids/*")
public class CapturePlasmidsController {
    private static final Logger logger = LoggerFactory.getLogger(CapturePlasmidsController.class);
    ...
    public String initAddEntityForm(Model model) {
        ...
        this.visitsService.saveUserPages(this.usuarioService.getUser(SecurityContextHolder.getContext().getAuthentication().getName()),new Date(),"captureplasmidspage");
        return "capture/plasmids/enterNewForm";
    }
