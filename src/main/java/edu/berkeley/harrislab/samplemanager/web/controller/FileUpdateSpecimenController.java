 ...
 */
@Controller
@RequestMapping("/admin/fileupdatespecimen/*")
public class FileUpdateSpecimenController {
    ...
    public String obtenerEntidades(Model model) throws ParseException {
        ...
        return "admin/fileuploadexcell/uploadExcelSpecimen";
    }
        ...
        try {
            ...
            while (numFilas > contc) {
                ...
                if  (sheet.getRow(1).getCell(contf) != null)  {
                        ...
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("specimenId")) {
                            ...
                            if (entidad == null && !specimenId.toString().isEmpty()) {
                               ...
                               // entidades_error.add(numNoact,entidad_error);
                                codigos_error.add(numNoact,specimenId + "  Error: specimenId, exist");
                    ...
                    if  (sheet.getRow(1).getCell(contf) != null) {
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("labReceiptDate")) {
                            ...
                            if ((entidad != null) && !Record_date.toString().isEmpty()) {
                                SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                                entidad.setLabReceiptDate(formatter.parse(Record_date));
                                contfinalrows = contfinalrows + 1;
                                contf++;
                            } else {
                    ...
                    if  (sheet.getRow(1).getCell(contf) != null) {
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("Volume_Units")) {
                            if (!sheet.getRow(contc).getCell(contf).toString().equals("")) {
                                Record_user = sheet.getRow(contc).getCell(contf).toString();
                                contf++;
                            }
                            if ((entidad != null) && !Record_user.toString().isEmpty()) {
                                entidad.setVolUnits(Record_user);
                                contfinalrows = contfinalrows + 1;
                                contf++;
                            } else {
                                entidad_error.setObs(entidad_error.getSpecimenId() + "  " + entidad_error.getObs() + " Error: inStorage, ");
                    ...
                    if  (sheet.getRow(1).getCell(contf) != null) {
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("StudyId")) {
                            if (!sheet.getRow(contc).getCell(contf).toString().equals("")) {
                                Record_user = sheet.getRow(contc).getCell(contf).toString();
                                contf++;
                            }
                            if ((entidad != null) && !Record_user.toString().isEmpty()) {
                              //  entidad.setSubjectId(Record_user);
                                contfinalrows = contfinalrows + 1;
                                contf++;
                            } else {
                                entidad_error.setObs(entidad_error.getSpecimenId() + "  " + entidad_error.getObs() + " Error: inStorage, ");
                    ...
                    if  (sheet.getRow(1).getCell(contf) != null) {
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("substudy")) {
                            if (!sheet.getRow(contc).getCell(contf).toString().equals("")) {
                                Record_user = sheet.getRow(contc).getCell(contf).toString();
                                contf++;
                            }
                            if ((entidad != null) && !Record_user.toString().isEmpty()) {
                                entidad.setSubstudy(Record_user);
                                contfinalrows = contfinalrows + 1;
                                contf++;
                            } else {
                                entidad_error.setObs(entidad_error.getSpecimenId() + "  " + entidad_error.getObs() + " Error: inStorage, ");
                    ...
                    if  (sheet.getRow(1).getCell(contf) != null) {
                        if (sheet.getRow(1).getCell(contf).toString().equalsIgnoreCase("inStorage")) {
                            ...
                            if (!inStorage.toString().isEmpty() && entidad.getVolume() != 0 ) {
