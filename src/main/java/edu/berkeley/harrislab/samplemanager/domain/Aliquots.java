...
/*
@Entity
@Table(name = "aliquots", catalog = "samplemanager", uniqueConstraints = @UniqueConstraint(columnNames = "aliquotId"))
public class Aliquots extends BaseMetaData implements Auditable{
	/**
	 *
	 */
...
/*
	...
	public Aliquots(Date recordDate, String recordUser, String recordIp, char pasive) {
	...
	public boolean equals(Object other) {
		...
		Aliquots castOther = (Aliquots) other;
